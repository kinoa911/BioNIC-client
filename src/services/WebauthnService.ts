...
async function getAttestationCreationOptions(discoverable: boolean): Promise<PublicKeyCredentialCreationOptionsStatus> {
    console.log("getAttestationCreationOptions discoverable: ", discoverable);
    ...
    console.log("getAttestationCreationOptions response.data.status: ", response.data, response.data.status);

    if (response.data.status !== "OK" || response.data.data == null) {
        console.log("getAttestationCreationOptions fail");
    ...
    console.log("getAttestationCreationOptions response: ", response.data.data.publicKey);
    return {
...
async function getAssertionRequestOptions(discoverable: boolean): Promise<PublicKeyCredentialRequestOptionsStatus> {
    ...
    console.log("getAssertionRequestOptions", discoverable)
    if (discoverable) {
...
async function getAttestationPublicKeyCredentialResult(creationOptions: PublicKeyCredentialCreationOptions): Promise<AttestationPublicKeyCredentialResult> {
    console.log("getAttestationPublicKeyCredentialResult creationOptions: ", creationOptions);
    ...
    try {
        ...
        console.log("getAttestationPublicKeyCredentialResult navigator.credentials.create exception: ", e);
...
async function getAssertionPublicKeyCredentialResult(requestOptions: PublicKeyCredentialRequestOptions): Promise<AssertionPublicKeyCredentialResult> {
    ...
    console.log("getAssertionPublicKeyCredentialResult")
    try {
...
export async function performAttestationCeremony(discoverable: boolean = false): Promise<AttestationResult> {
    console.log("performAttestationCeremony");
    const attestationCreationOpts = await getAttestationCreationOptions(discoverable);
    console.log("performAttestationCeremony getAttestationCreationOptions: ", attestationCreationOpts.status, attestationCreationOpts.options);

    if (attestationCreationOpts.status !== 200 || attestationCreationOpts.options == null) {
        console.log("performAttestationCeremony return AttestationResult.Failure");
        return AttestationResult.Failure;
    }

    const attestationResult = await getAttestationPublicKeyCredentialResult(attestationCreationOpts.options);
    console.log("performAttestationCeremony getAttestationPublicKeyCredentialResult");
    ...
    console.log("performAttestationCeremony postAttestationPublicKeyCredentialResult");
...
export async function performAssertionCeremony(discoverable: boolean = false): Promise<AssertionResult> {
    ...
    console.log("performAssertionCeremony getAssertionRequestOptions")
    if (assertionRequestOpts.status !== 200 || assertionRequestOpts.options == null) {
        return AssertionResult.Failure;
    }

    console.log("performAssertionCeremony getAssertionRequestOptions ok")
